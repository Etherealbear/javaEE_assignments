...
public class CodeGenerator {
    ...
    private static PackageConfig packageConfig() {
        ...
        packageInfo.setParent("edu.cn.demo");
        //设置实体类包名
    ...
    private static GlobalConfig globalConfig() {
        ...
        //设置作者
        globalConfig.setAuthor("lirongjun");
        //设置是否覆盖原始生成的文件
    ...
    private static DataSourceConfig dataSourceConfig() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/productsdb?serverTimezone=UTC");
        dataSource.setUsername("root");
        dataSource.setPassword("381254lrj");
        return dataSource;
    }
}
